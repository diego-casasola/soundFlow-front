...
@Component({
  selector: 'app-desafio10',
  templateUrl: './desafio10.component.html',
  styleUrls: ['./desafio10.component.scss']
})
export class Desafio10Component implements OnInit {
    ...
    this.pruebasService.getPruebas(parseInt(this.desafioId)).subscribe(
      (res) => {
        res.forEach((prueba: Prueba) => {
          const incompleto: string[] = prueba.datos.split(',');
